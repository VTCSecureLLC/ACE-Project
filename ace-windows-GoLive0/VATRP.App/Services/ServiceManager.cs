...
namespace com.vtcsecure.ace.windows.Services
{
    internal class ServiceManager : ServiceManagerBase
    {
       ...
       // public const string CDN_DOMAIN = "192.168.5.132/mit";
        public const string CDN_DOMAIN_URL = "http://" + CDN_DOMAIN + "/nvn/domains.json";
        ...
        {
            UpdateProvidersList(); //Download the provider list.
